# Deprecation / cleanup — reference

Domain knowledge for behavior-preserving modernization. Consulted when a task removes dead code, collapses
deprecated APIs, or de-crufts — never a feature change.
