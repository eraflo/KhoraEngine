...
use crate::core::metrics::backend::MetricsBackend;
use crate::core::metrics::memory_backend::InMemoryBackend;
use crate::core::metrics::types::{Metric, MetricId, MetricType, MetricsError, MetricsResult};
use std::sync::Arc;
...
mod tests {
    ...
    fn test_histogram_registration_and_operations() {
        ...
        if let crate::core::metrics::types::MetricValue::Histogram { samples, .. } = metric.value {
