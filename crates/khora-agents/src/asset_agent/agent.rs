...
use khora_lanes::asset_lane::{AssetLoader, PackLoadingLane};
use std::fs::File;

use crate::asset_agent::loader::LoaderRegistry;
...
impl AssetAgent {
    ...
    /// Registers an `AssetLoader` for a specific asset type name.
    ///
