...
use khora_core::renderer::{
    api::{
        ...
        scene::{
            DirectionalLightUniform, GpuMesh, LightingUniforms, MaterialUniforms, ModelUniforms,
...
fn init_gpu_resources(
    ...
    layout_entries.extend(khora_data::render::shadow_bindings::shadow_bind_group_layout_entries());
